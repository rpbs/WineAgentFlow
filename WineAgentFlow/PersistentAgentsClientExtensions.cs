...
using BingGroundingSearchConfiguration = Azure.AI.Agents.Persistent.BingGroundingSearchConfiguration;
using BingGroundingSearchToolParameters = Azure.AI.Agents.Persistent.BingGroundingSearchToolParameters;
using BingGroundingToolDefinition = Azure.AI.Agents.Persistent.BingGroundingToolDefinition;
using CodeInterpreterToolDefinition = Azure.AI.Agents.Persistent.CodeInterpreterToolDefinition;
using FileSearchToolDefinition = Azure.AI.Agents.Persistent.FileSearchToolDefinition;
using PersistentAgent = Azure.AI.Agents.Persistent.PersistentAgent;
using PersistentAgentsClient = Azure.AI.Agents.Persistent.PersistentAgentsClient;
using ToolDefinition = Azure.AI.Agents.Persistent.ToolDefinition;

namespace WineAgentFlow;

/// <summary>
/// Provides extension methods for <see cref="Azure.AI.Agents.Persistent.PersistentAgentsClient"/>.
/// </summary>
public static class PersistentAgentsClientExtensions
{
    ...
    private static (List<ToolDefinition>? ToolDefinitions, Azure.AI.Agents.Persistent.ToolResources? ToolResources, List<AITool>? FunctionToolsAndOtherTools) ConvertAIToolsToToolDefinitions(IList<AITool>? tools)
    {
